    ...
    <div class="max-w-7xl w-full mx-auto pt-2 sm:px-6 lg:px-8">
      <div class="flex flex-col lg:flex-row w-full lg:space-x-2 space-y-2 lg:space-y-0 mb-2 lg:mb-4">
        <div class="w-full lg:w-1/4">
          <div class="widget w-full p-4 rounded-lg bg-red-600 border border-gray-100 dark:bg-gray-900 dark:border-gray-800">
            <div class="flex flex-row items-center justify-between">
              <div class="flex flex-col">
                <div class="text-xs uppercase font-light text-gray-600 font-bold">
                  Subscriptores
                </div>
                <div class="text-xl font-bold">8000</div>
              </div>
              <svg
        ...
        <div class="w-full lg:w-1/4">
          <div class="widget w-full p-4 rounded-lg bg-emerald-500 border border-gray-100 dark:bg-gray-900 dark:border-gray-800">
            <div class="flex flex-row items-center justify-between">
              <div class="flex flex-col">
                <div class="text-xs uppercase font-light text-gray-500">
                  VISITAS
                </div>
                <div class="text-xl font-bold">300.000 </div>
              </div>
              <svg
                class="stroke-current text-gray-500"
                fill="none"
        ...
        <div class="w-full lg:w-1/4">
          <div class="widget w-full p-4 rounded-lg bg-blue-200 border border-gray-100 dark:bg-gray-900 dark:border-gray-800">
            <div class="flex flex-row items-center justify-between">
              <div class="flex flex-col">
                <div class="text-xs uppercase font-light text-gray-500">
                  Charlas
        ...
        <div class="w-full lg:w-1/4">
          <div class="widget w-full p-4 rounded-lg bg-yellow-200 border border-gray-100 dark:bg-gray-900 dark:border-gray-800">
            <div class="flex flex-row items-center justify-between">
              <div class="flex flex-col">
                <div class="text-xs uppercase font-light text-gray-500">
                  Watch Time
                </div>
                <div class="text-xl font-bold">+34.000h</div>
              </div>
              <svg
                class="stroke-current text-gray-500"
                fill="none"
